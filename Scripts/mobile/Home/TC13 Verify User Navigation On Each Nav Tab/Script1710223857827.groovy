...
Mobile.verifyElementText(findTestObject('Object Repository/Home/Home Screen Title'), HomePageTitle)

Mobile.tap(findTestObject('Object Repository/Home/Vetchat Tab'), GlobalVariable.ShortTimeout)

Mobile.verifyElementText(findTestObject('Object Repository/Home/Vetchat Screen Title'), VetChatPageTitle)

Mobile.tap(findTestObject('Object Repository/Home/Pet Profile Tab'), GlobalVariable.ShortTimeout)

Mobile.verifyElementText(findTestObject('Object Repository/Home/Pet Profile Screen Title'), PetProfilePageTitle)

Mobile.tap(findTestObject('Object Repository/Home/User Profile Tab'), GlobalVariable.ShortTimeout)

Mobile.verifyElementText(findTestObject('Object Repository/Home/User Profile Screen Title'), UserProfilePageTitle)
