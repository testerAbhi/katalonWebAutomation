...
Mobile.verifyElementVisible(findTestObject('Object Repository/Home/Home Tab'), GlobalVariable.ShortTimeout)
Mobile.verifyElementVisible(findTestObject('Object Repository/Home/Vetchat Tab'), GlobalVariable.ShortTimeout)
Mobile.verifyElementVisible(findTestObject('Object Repository/Home/Pet Profile Tab'), GlobalVariable.ShortTimeout)
Mobile.verifyElementVisible(findTestObject('Object Repository/Home/User Profile Tab'), GlobalVariable.ShortTimeout)
