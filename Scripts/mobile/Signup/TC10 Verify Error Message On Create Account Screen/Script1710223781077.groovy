...
Mobile.tap(findTestObject('Object Repository/Signup/Create Account Screen/Create Account Button'), GlobalVariable.ShortTimeout)
Mobile.verifyElementText(findTestObject('Object Repository/Signup/Create Account Screen/Blank Password Error'), BlankPasswordError)

Mobile.setText(findTestObject('Object Repository/Signup/Create Account Screen/Create Password Field'), IncompletePassword, GlobalVariable.ShortTimeout)
Mobile.hideKeyboard()
Mobile.tap(findTestObject('Object Repository/Signup/Create Account Screen/Create Account Button'), GlobalVariable.ShortTimeout)
Mobile.verifyElementText(findTestObject('Object Repository/Signup/Create Account Screen/Password Incomplete Error'), IncompletePasswordError)
