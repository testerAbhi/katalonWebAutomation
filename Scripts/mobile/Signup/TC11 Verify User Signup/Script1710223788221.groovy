...
Mobile.setText(findTestObject('Object Repository/Signup/Create Account Screen/Create Password Field'), NewPassword, GlobalVariable.ShortTimeout)
Mobile.hideKeyboard()
...
Mobile.verifyElementText(findTestObject('Object Repository/Signup/Signup Base Objects/Subscribtion Header'), SubscriptionHeader)
