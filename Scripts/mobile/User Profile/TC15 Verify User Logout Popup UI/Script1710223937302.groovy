...
Mobile.verifyElementVisible(findTestObject('Object Repository/Home/User Profile Screen Title'), GlobalVariable.ShortTimeout)

Mobile.scrollToText(LogoutBtnText)
Mobile.verifyElementVisible(findTestObject('Object Repository/User Profile/Logout Label/Logout Button'), GlobalVariable.ShortTimeout)
Mobile.tap(findTestObject('Object Repository/User Profile/Logout Label/Logout Button'), GlobalVariable.ShortTimeout)

Mobile.verifyElementVisible(findTestObject('Object Repository/User Profile/Logout Label/Close Logout Popup Button'), GlobalVariable.ShortTimeout)
Mobile.verifyElementText(findTestObject('Object Repository/User Profile/Logout Label/Logout Popup Title'), LogoutPopupTitle)
Mobile.verifyElementVisible(findTestObject('Object Repository/User Profile/Logout Label/Pet Animation On Logout Popup'), GlobalVariable.ShortTimeout)
Mobile.verifyElementText(findTestObject('Object Repository/User Profile/Logout Label/Confirm Logout Button'), ConfirmLogoutButtonText)
Mobile.verifyElementText(findTestObject('Object Repository/User Profile/Logout Label/Nevermind Link Text'), NevermindLinkText)
