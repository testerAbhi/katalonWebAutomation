...
((AndroidDriver) driver).pushFile("/sdcard/download/UserPhoto.png", new File(GlobalVariable.ImagePath));
println(GlobalVariable.ImagePath)
...
Mobile.tap(findTestObject('Object Repository/User Profile/User Profile Base Objects/Edit User Profile Photo'), GlobalVariable.ShortTimeout)

Mobile.tap(findTestObject('Object Repository/User Profile/User Profile Base Objects/Choose from Library Option'), GlobalVariable.ShortTimeout)

Mobile.tap(findTestObject('Object Repository/User Profile/User Profile Base Objects/Select Photo'), GlobalVariable.ShortTimeout)

Mobile.tap(findTestObject('Object Repository/User Profile/User Profile Base Objects/Crop Image'), GlobalVariable.ShortTimeout)

Mobile.verifyElementText(findTestObject('Object Repository/User Profile/User Profile Base Objects/Photo Updated Message'), SuccessMessage)
