...
Mobile.verifyElementText(findTestObject('Object Repository/User Profile/Account Settings Label/Change Password/Change Password Screen Title'),
		PageTitle)

Mobile.verifyElementVisible(findTestObject('Object Repository/User Profile/Account Settings Label/Change Password/Current Password Field'),
		GlobalVariable.ShortTimeout)

Mobile.verifyElementVisible(findTestObject('Object Repository/User Profile/Account Settings Label/Change Password/New Password Field'),
		GlobalVariable.ShortTimeout)

Mobile.verifyElementVisible(findTestObject('Object Repository/User Profile/Account Settings Label/Change Password/Re-enter New Password Field'),
		GlobalVariable.ShortTimeout)

Mobile.verifyElementNotVisible(findTestObject('Object Repository/User Profile/Account Settings Label/Change Password/Save Password'),
		GlobalVariable.ShortTimeout, FailureHandling.STOP_ON_FAILURE)
