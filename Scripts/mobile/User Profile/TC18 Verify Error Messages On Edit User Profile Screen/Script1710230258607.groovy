...
Mobile.clearText(findTestObject('Object Repository/User Profile/Edit User Details/Edit Last Name'), GlobalVariable.ShortTimeout)

Mobile.verifyElementText(findTestObject('Object Repository/User Profile/Edit User Details/Blank First Name Error'), BlankFirstNameError)

Mobile.verifyElementText(findTestObject('Object Repository/User Profile/Edit User Details/Blank Last Name Error'), BlankLastNameError)
