...
Mobile.waitForElementPresent(findTestObject('Object Repository/Login/Email Screen/Email Input Field'), GlobalVariable.ShortTimeout, FailureHandling.STOP_ON_FAILURE)
...
Mobile.setText(findTestObject('Object Repository/User Profile/Edit User Details/Edit First Name'), FirstName, GlobalVariable.ShortTimeout)

Mobile.setText(findTestObject('Object Repository/User Profile/Edit User Details/Edit Last Name'), LastName, GlobalVariable.ShortTimeout)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Object Repository/User Profile/Edit User Details/Save Button'), GlobalVariable.ShortTimeout)
