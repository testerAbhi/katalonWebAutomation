...
Mobile.tap(findTestObject('Object Repository/Login/Password Screen/Back Arrow On Password Screen'), GlobalVariable.ShortTimeout)
Mobile.verifyElementText(findTestObject('Object Repository/Login/Email Screen/Email Screen Title'), EmailScreenTitle)

Mobile.tap(findTestObject('Object Repository/Login/Email Screen/Back Arrow On Email Screen'), GlobalVariable.ShortTimeout)
Mobile.verifyElementVisible(findTestObject('Object Repository/Login/Login Base Objects/ContinueWithEmailBtn'), GlobalVariable.ShortTimeout)
