...
Mobile.verifyElementText(findTestObject('Object Repository/Login/Email Screen/Blank Email Error'), BlankFieldError)

Mobile.setText(findTestObject('Object Repository/Login/Email Screen/Email Input Field'), InValidEmail, 0)
Mobile.tap(findTestObject('Object Repository/Login/Login Base Objects/Continue Or Login Button'), GlobalVariable.ShortTimeout)
Mobile.verifyElementText(findTestObject('Object Repository/Login/Email Screen/Invalid Email Error'), InvalidEmailError)
